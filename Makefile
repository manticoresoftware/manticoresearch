...
ACLOCAL = ${SHELL} /benchmarks/ext3/BUILDS/sphinx.conf/config/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /benchmarks/ext3/BUILDS/sphinx.conf/config/missing --run tar
AUTOCONF = ${SHELL} /benchmarks/ext3/BUILDS/sphinx.conf/config/missing --run autoconf
AUTOHEADER = ${SHELL} /benchmarks/ext3/BUILDS/sphinx.conf/config/missing --run autoheader
AUTOMAKE = ${SHELL} /benchmarks/ext3/BUILDS/sphinx.conf/config/missing --run automake-1.9
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /benchmarks/ext3/BUILDS/sphinx.conf/config/missing --run makeinfo
MYSQL_CFLAGS = -I/usr/local/mysql/include/mysql
MYSQL_LIBS = -L/usr/local/mysql/lib/mysql -lmysqlclient_r -lz -lcrypt -lnsl -lm
OBJEXT = o
PACKAGE = sphinx
PACKAGE_BUGREPORT = shodan@shodan.ru
PACKAGE_NAME = sphinx
PACKAGE_STRING = sphinx 0.9.7
...
infodir = ${prefix}/info
install_sh = /benchmarks/ext3/BUILDS/sphinx.conf/config/install-sh
