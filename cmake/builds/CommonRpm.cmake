...
string(REPLACE "-" "." TZDATA_VERHASH_FIXED "${TZDATA_VERHASH}")
set ( DEP_TZDATA_VERSION "${TZDATA_VERNUM}_${TZDATA_VERDATE}.${TZDATA_VERHASH_FIXED}" )
string(REPLACE "-" "." BUDDY_VERHASH_FIXED "${BUDDY_VERHASH}")
set ( DEP_BUDDY_VERSION "${BUDDY_VERNUM}+${BUDDY_VERDATE}.${BUDDY_VERHASH_FIXED}" )
string(REPLACE "-" "." BACKUP_VERHASH_FIXED "${BACKUP_VERHASH}")
set ( DEP_BACKUP_VERSION "${BACKUP_VERNUM}+${BACKUP_VERDATE}.${BACKUP_VERHASH_FIXED}" )
...
set ( CPACK_RPM_SEARCHD_PACKAGE_REQUIRES "manticore-common = ${MYVER}, manticore-tzdata = ${DEP_TZDATA_VERSION}" )
