...
function ( INSTALL_BINARY BINARYNAME )
	if ( CMAKE_VERSION VERSION_LESS 3.5.1 )
		INSTALL ( TARGETS ${BINARYNAME} RUNTIME DESTINATION bin COMPONENT APPLICATIONS )
	else ()
		INSTALL ( PROGRAMS $<TARGET_FILE:${BINARYNAME}> DESTINATION bin COMPONENT APPLICATIONS )
	endif ()
endfunction()
