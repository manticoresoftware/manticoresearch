...
docker tag ${distr}_clang:12 registry.gitlab.com/manticoresearch/dev/${distr}_clang:12
...
echo "docker push registry.gitlab.com/manticoresearch/dev/${distr}_clang:12"
