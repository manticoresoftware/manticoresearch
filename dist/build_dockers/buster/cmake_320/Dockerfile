...
# docker build -t buster_cmake:320 -t registry.gitlab.com/manticoresearch/dev/buster_cmake:320 -t registry.gitlab.com/manticoresearch/dev/buster_cmake:latest .
