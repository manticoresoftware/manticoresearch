...
# docker build -t bionic_cmake:320 -t registry.gitlab.com/manticoresearch/dev/bionic_cmake:320 -t registry.gitlab.com/manticoresearch/dev/bionic_cmake:latest .
