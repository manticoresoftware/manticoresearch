...
docker tag ${distr}_clang:11 registry.gitlab.com/manticoresearch/dev/${distr}_clang:11
...
echo "docker push registry.gitlab.com/manticoresearch/dev/${distr}_clang:11"
