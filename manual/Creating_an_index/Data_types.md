...
* just `string` by default means `attribute` (see details [below](../Searching/Data_types.md#Text)).
* just `text` by default means `stored` + `indexed` (see details [below](../Searching/Data_types.md#String)).
