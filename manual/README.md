...
* [▪️ Creating a table](Creating_an_index.md)
    ...
    * [Creating a local table](Creating_an_index/Local_indexes.md)
        * [✔ Real-time table](Creating_an_index/Local_indexes/Real-time_index.md)
        * [Plain table](Creating_an_index/Local_indexes/Plain_index.md)
        * [Plain and real-time table settings](Creating_an_index/Local_indexes/Plain_and_real-time_index_settings.md)
        * [Percolate table](Creating_an_index/Local_indexes/Percolate_index.md)
        * [Template table](Creating_an_index/Local_indexes/Template_index.md)
    ...
    * [Creating a distributed table](Creating_an_index/Creating_a_distributed_index/Creating_a_distributed_index.md)
        * [Creating a local distributed table](Creating_an_index/Creating_a_distributed_index/Creating_a_local_distributed_index.md)
        * [Remote tables](Creating_an_index/Creating_a_distributed_index/Remote_indexes.md)
* [▪️ Listing tables](Listing_indexes.md)
* [▪️ Deleting a table](Deleting_an_index.md)
* [▪️ Emptying a table](Emptying_an_index.md)
* [▪️ Creating a cluster](Creating_a_cluster/Creating_a_cluster.md)
    ...
    * [Setting up replication](Creating_a_cluster/Setting_up_replication/Setting_up_replication.md)
        ...
        * [Adding and removing a table from a replication cluster](Creating_a_cluster/Setting_up_replication/Adding_and_removing_an_index_from_a_replication_cluster.md)
...
* [▪️ Adding documents to a table]
    * [✔ Adding documents to a real-time table](Adding_documents_to_an_index/Adding_documents_to_a_real-time_index.md)
    * [Adding rules to a percolate table](Adding_documents_to_an_index/Adding_rules_to_a_percolate_index.md)
* [▪️ Adding data from external storages]
    * [Plain tables creation](Adding_data_from_external_storages/Plain_indexes_creation.md)
    * [Fetching from databases]
        ...
        * [Processing fetched data](Adding_data_from_external_storages/Fetching_from_databases/Indexing_fetched_data.md)
    ...
    * [Adding data from tables]
        * [Merging tables](Adding_data_from_external_storages/Adding_data_from_indexes/Merging_indexes.md)
        * [Killlists in plain tables](Adding_data_from_external_storages/Adding_data_from_indexes/Killlist_in_plain_indexes.md)
        * [Attaching a plain table to RT table](Adding_data_from_external_storages/Adding_data_from_indexes/Attaching_a_plain_index_to_RT_index.md)
        * [Importing RT table](Adding_data_from_external_storages/Adding_data_from_indexes/Importing_index.md)        
    * [Rotating a table](Adding_data_from_external_storages/Rotating_an_index.md)
* [✔ Updating documents]
...
* [▪️ Securing and compacting a table]
    ...
    * [Few words about RT table structure](Securing_and_compacting_an_index/RT_index_structure.md)
    * [Flushing RAM chunk to a new disk chunk](Securing_and_compacting_an_index/Flushing_RAM_chunk_to_a_new_disk_chunk.md)
    * [Flushing RT table to disk](Securing_and_compacting_an_index/Flushing_RAM_chunk_to_disk.md)
    * [Compacting a table](Securing_and_compacting_an_index/Compacting_an_index.md)
...
* [▪️ Profiling and monitoring]
    ...
    * [Table settings and status]
        * [SHOW TABLE STATUS](Profiling_and_monitoring/Index_settings_and_status/SHOW_INDEX_STATUS.md)
        * [SHOW TABLE SETTINGS](Profiling_and_monitoring/Index_settings_and_status/SHOW_INDEX_SETTINGS.md)
* [▪️ Server settings]
