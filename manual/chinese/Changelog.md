...
* 🆕 [v14.4.0](https://github.com/manticoresoftware/manticoresearch/releases/tag/14.4.0) [ PR #3942](https://github.com/manticoresoftware/manticoresearch/pull/3942) 更新了 Manticore Buddy 要求至 3.38.0，过滤掉零文档建议，改进了使用 Ds\Map 的字符串键处理，将 Buddy 中的内存使用报告格式从 KB 改为字节以提高精度，并提升了性能、稳定性和可维护性。
* 🆕 [v14.5.0](https://github.com/manticoresoftware/manticoresearch/releases/tag/14.5.0) [ Issue #3329](https://github.com/manticoresoftware/manticoresearch/issues/3329) 在记录查询请求时修剪 JSON 负载中的多余空白和换行——跳过前后空格以避免记录格式错误的 JSON。
