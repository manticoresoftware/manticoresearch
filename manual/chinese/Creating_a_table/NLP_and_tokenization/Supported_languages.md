...
| 蒙达语 | 需手动指定charset_table | - | - | |
| 霍语 | 需手动指定charset_table | - | - | |
| 匈牙利语 | charset_table=non_cont | hu | morphology=libstemmer_hu | |
| 印尼语 | charset_table=non_cont | id | morphology=libstemmer_id | |
...
| 科米语 | 需手动指定charset_table | - | - | |
| 韩语 | ngram_chars=korean | - | ngram_chars=korean ngram_len=1 | 需要基于ngram的分词  |
| 大花苗语 | 需手动指定charset_table | - | - | |
| 拉丁语 | charset_table=non_cont | la | - | |
| 拉脱维亚语 | charset_table=non_cont | lv | - | |
| 立陶宛语 | charset_table=non_cont | lt | morphology=libstemmer_lt | |
| 马巴语 | 需手动指定charset_table | - | - | |
| 马提利语 | 需手动指定charset_table | - | - | |
| 马拉地语 | 需手动指定charset_table | - | - | |
| 马拉地语 | charset_table=non_cont | mr | - | |
| 门德语 | 需手动指定charset_table | - | - | |
| 马鲁语 | 需手动指定charset_table | - | - | |
| 美尼语 | 需手动指定charset_table | - | - | |
| 尼泊尔语 | 需手动指定charset_table | - | morphology=libstemmer_ne | |
| 甘巴伊语 | 需手动指定charset_table | - | - | |
| 挪威语 | charset_table=non_cont | no | morphology=libstemmer_no | |
| 奥里亚语 | 需手动指定charset_table | - | - | |
...
| 锡尔赫提语 | 需手动指定charset_table | - | - | |
| 泰米尔语 | 需手动指定charset_table | - | morphology=libstemmer_ta | |
| 泰语 | charset_table=thai | th | - | |
| 土耳其语 | charset_table=non_cont | tr | morphology=libstemmer_tr | |
| 乌克兰语 | charset_table=non_cont,U+0406->U+0456,U+0456,U+0407->U+0457,U+0457,U+0490->U+0491,U+0491 | - | morphology=lemmatize_uk (单根形式); morphology=lemmatize_uk_all (所有根形式) | 覆盖`charset_table`以保留`і`、`ї`和`ґ` |
