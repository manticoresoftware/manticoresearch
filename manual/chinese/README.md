...
* [3️⃣ 创建表](Creating_a_table.md)
    ...
    * [≫ NLP 和分词]
        ...
        * [• 连续书写脚本语言](Creating_a_table/NLP_and_tokenization/Languages_with_continuous_scripts.md)
        * [• 底层分词](Creating_a_table/NLP_and_tokenization/Low-level_tokenization.md)
        ...
        * [• 例外项](Creating_a_table/NLP_and_tokenization/Exceptions.md)
...
* [≫ 创建集群](Creating_a_cluster/Creating_a_cluster.md)
    ...
    * [≫ 配置复制](Creating_a_cluster/Setting_up_replication/Setting_up_replication.md)
        ...
        * [理解复制状态](Creating_a_cluster/Setting_up_replication/Understanding_cluster_status_and_node_states.md)
...
* [≫ 数据创建和修改](Data_creation_and_modification/Data_creation_and_modification.md)
    * [≫ 向表中添加文档]
        ...
        * [向 percolate 表添加规则](Data_creation_and_modification/Adding_documents_to_a_table/Adding_rules_to_a_percolate_table.md)
    * [≫ 从外部存储添加数据](Data_creation_and_modification/Adding_data_from_external_storages.md)
        ...
        * [≫ 从数据库获取]
            ...
            * [获取查询的执行](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_databases/Execution_of_fetch_queries.md)
            * [获取数据的处理](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_databases/Processing_fetched_data.md)
        ...
        * [• Main+delta 架构](Data_creation_and_modification/Adding_data_from_external_storages/Main_delta.md)
        * [≫ 从表中添加数据]
...
* [5️⃣ 搜索](Searching.md)
    ...
    * [• 排序和相关性评分](Searching/Sorting_and_ranking.md)
...
* [• 更新表结构和设置](Updating_table_schema_and_settings.md)
    ...
    * [• 在更改 FT 设置后重新索引现有文档](Updating_table_schema_and_settings.md#Reindexing-existing-documents-after-changing-FT-settings)
...
* [≫ 函数]
    ...
    * [• 搜索和排序函数](Functions/Searching_and_ranking_functions.md)
...
* [≫ 保护和压缩表]
    ...
    * [• 将 RAM chunk 刷新到新的磁盘 chunk](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_a_new_disk_chunk.md)
    ...
    * [• 冻结并锁定表](Securing_and_compacting_a_table/Freezing_and_locking_a_table.md)
...
* [≫ 日志记录]
    ...
    * [• 轮转查询日志和服务器日志](Logging/Rotating_query_and_server_logs.md)
* [≫ 节点信息和管理]
...
* [≫ 服务器设置]
    ...
    * [• 表和 source 声明的继承](Server_settings/Inheritance_of_table_and_source_declarations.md)
...
* [≫ 扩展]
    ...
    * [≫ UDF 和插件](Extensions/UDFs_and_Plugins/UDFs_and_Plugins.md)
        ...
        * [≫ 插件]
            ...
            * [• 排序器插件](Extensions/UDFs_and_Plugins/Plugins/Ranker_plugins.md)
            * [• 分词过滤器插件](Extensions/UDFs_and_Plugins/Plugins/Token_filter_plugins.md)
* [• 杂项工具](Miscellaneous_tools.md)
* [• OpenAPI 规范](Openapi.md)
* [• 遥测](Telemetry.md)
* [• 更新日志](Changelog.md)
* [🐞 报告 bug](Reporting_bugs.md)
* [📖 参考资料](References.md)
    * [• 旧版 Manticore 文档](References.md#Documentation-for-old-Manticore-versions)
<!-- proofread -->
