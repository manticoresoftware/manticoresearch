...
* [3️⃣ 创建表](Creating_a_table.md)
    * [⪢ 数据类型](Creating_a_table/Data_types.md)
        * [• 行存储和列存储属性](Creating_a_table/Data_types.md#Row-wise-and-columnar-attribute-storages)
    ...
    * [⪢ NLP 和分词]
        ...
        * [• 连续脚本的语言](Creating_a_table/NLP_and_tokenization/Languages_with_continuous_scripts.md)
        ...
        * [• 单词形式](Creating_a_table/NLP_and_tokenization/Wordforms.md)
...
* [⪢ 创建集群](Creating_a_cluster/Creating_a_cluster.md)
    ...
    * [⪢ 设置复制](Creating_a_cluster/Setting_up_replication/Setting_up_replication.md)
        ...
        * [从复制集群中添加和移除表](Creating_a_cluster/Setting_up_replication/Adding_and_removing_a_table_from_a_replication_cluster.md)
...
* [⪢ 数据创建和修改](Data_creation_and_modification/Data_creation_and_modification.md)
    ...
    * [⪢ 从外部存储添加数据](Data_creation_and_modification/Adding_data_from_external_storages.md)
        ...
        * [⪢ 从数据库提取]
            ...
            * [执行提取查询](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_databases/Execution_of_fetch_queries.md)
        ...
        * [从XML流中获取](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_XML_streams.md)
        * [• 从CSV,TSV中获取](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_CSV,TSV.md)
        * [• 主+增量架构](Data_creation_and_modification/Adding_data_from_external_storages/Main_delta.md)
        * [⪢ 从表中添加数据]
            * [• 合并表](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Merging_tables.md)
            * [• 普通表中的杀死列表](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Killlist_in_plain_tables.md)
            ...
            * [• 导入RT表](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Importing_table.md)
        * [• 旋转一张表](Data_creation_and_modification/Adding_data_from_external_storages/Rotating_a_table.md)
    * [⪢ 更新文档]
        * [• REPLACE与UPDATE](Data_creation_and_modification/Updating_documents/REPLACE_vs_UPDATE.md)
...
* [5️⃣ 搜索]
    ...
    * [• K最近邻向量搜索](Searching/KNN.md)
* [• 更新表结构和设置](Updating_table_schema_and_settings.md)
    * [• 在RT模式下更新表结构](Updating_table_schema_and_settings.md#Updating-table-schema-in-RT-mode)
    * [• 在RT模式下更新表FT设置](Updating_table_schema_and_settings.md#Updating-table-FT-settings-in-RT-mode)
    * [• 重命名实时表](Updating_table_schema_and_settings.md#Renaming-a-real-time-table)
    * [• 在普通模式下更新表FT设置](Updating_table_schema_and_settings.md#Updating-table-FT-settings-in-plain-mode)
...
* [⪢ 保护和压缩表]
    ...
    * [• 关于RT表结构的几句话](Securing_and_compacting_a_table/RT_table_structure.md)
    * [• 将RAM块刷新到新的磁盘块](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_a_new_disk_chunk.md)
    * [• 将RT表刷新到磁盘](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_disk.md)
...
* [⪢ 服务器设置]
    ...
    * [• 特别后缀](Server_settings/Special_suffixes.md)
...
* [⪢ 扩展]
    ...
    * [⪢ UDF和插件](Extensions/UDFs_and_Plugins/UDFs_and_Plugins.md)
        ...
        * [⪢ 插件]
            ...
            * [• 启用和禁用Buddy插件](Extensions/UDFs_and_Plugins/Plugins/Enabling_and_disabling_buddy_plugins.md)
