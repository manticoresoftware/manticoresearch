...
* [≫ 数据创建与修改](Data_creation_and_modification/Data_creation_and_modification.md)
    * [≫ 向表添加文档]
    ...
    * [≫ 从外部存储添加数据](Data_creation_and_modification/Adding_data_from_external_storages.md)
        ...
        * [≫ 从数据库获取]
            ...
            * [处理获取数据](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_databases/Processing_fetched_data.md)
            * [区间查询](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_databases/Ranged_queries.md)
        ...
        * [• 主+增量方案](Data_creation_and_modification/Adding_data_from_external_storages/Main_delta.md)
        * [≫ 从表添加数据]
            * [• 合并表](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Merging_tables.md)
            * [• 普通表中的 Killlists](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Killlist_in_plain_tables.md)
            * [• 挂载一张表到另一张表](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Attaching_one_table_to_another.md)
            * [• 导入实时表](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Importing_table.md)
        * [• 轮转表](Data_creation_and_modification/Adding_data_from_external_storages/Rotating_a_table.md)
    * [≫ 更新文档]
...
* [5️⃣ 搜索]
    ...
    * [≫ 全文匹配]
        ...
        * [• 搜索性能分析](Searching/Full_text_matching/Profiling.md)
    ...
    * [• 校对规则](Searching/Collations.md)
    * [• 基于代价的优化器](Searching/Cost_based_optimizer.md)
    * [• K 最近邻向量搜索](Searching/KNN.md)
* [• 更新表结构和设置](Updating_table_schema_and_settings.md)
    * [• 在实时模式下更新表结构](Updating_table_schema_and_settings.md#Updating-table-schema-in-RT-mode)
    * [• 在实时模式下更新表全文设置](Updating_table_schema_and_settings.md#Updating-table-FT-settings-in-RT-mode)
    * [• 重命名实时表](Updating_table_schema_and_settings.md#Renaming-a-real-time-table)
    * [• 在普通模式下更新表全文设置](Updating_table_schema_and_settings.md#Updating-table-FT-settings-in-plain-mode)
...
* [≫ 保护和压缩表]
    ...
    * [• 将内存区块刷新到新的磁盘区块](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_a_new_disk_chunk.md)
...
* [≫ 扩展]
    ...
    * [≫ UDF 和插件](Extensions/UDFs_and_Plugins/UDFs_and_Plugins.md)
        ...
        * [≫ 插件]
            ...
            * [• 词元过滤插件](Extensions/UDFs_and_Plugins/Plugins/Token_filter_plugins.md)
* [• 杂项工具](Miscellaneous_tools.md)
* [• OpenAPI 规范](Openapi.md)
* [• 遥测](Telemetry.md)
* [• 更新日志](Changelog.md)
* [🐞 报告缺陷](Reporting_bugs.md)
* [📖 参考文献](References.md)
    * [• 早期版本](References.md#Documentation-for-old-Manticore-versions)
<!-- proofread -->
