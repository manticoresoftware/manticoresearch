...
* [2️⃣ 启动服务器](Starting_the_server.md)
    * [• 在 Linux](Starting_the_server/Linux.md)
...
* [⪢ 数据创建和修改](Data_creation_and_modification/Data_creation_and_modification.md)
    ...
    * [⪢ 从外部存储添加数据](Data_creation_and_modification/Adding_data_from_external_storages.md)
        ...
        * [从 XML 流中获取](Data_creation_and_modification/Adding_data_from_external_storages/Fetching_from_XML_streams.md)
...
* [• 更新表结构和设置](Updating_table_schema_and_settings.md)
    ...
    * [• 普通模式下更新表全文设置](Updating_table_schema_and_settings.md#Updating-table-FT-settings-in-plain-mode)
...
* [⪢ 保护和压缩表]
    ...
    * [• 刷新和合并时的隔离](Securing_and_compacting_a_table/Isolation_during_flushing_and_merging.md)
