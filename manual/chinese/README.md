...
* [3️⃣ 创建表](Creating_a_table.md)
    * [⪢ 数据类型](Creating_a_table/Data_types.md)
        * [• 按行和按列的属性存储方式](Creating_a_table/Data_types.md#Row-wise-and-columnar-attribute-storages)
    * [⪢ 创建本地表](Creating_a_table/Local_tables.md)
        ...
        * [• 漏斗表](Creating_a_table/Local_tables/Percolate_table.md)
...
* [⪢ 数据创建与修改](Data_creation_and_modification/Data_creation_and_modification.md)
    * [⪢ 向表中添加文档]
        ...
        * [向漏斗表添加规则](Data_creation_and_modification/Adding_documents_to_a_table/Adding_rules_to_a_percolate_table.md)
    * [⪢ 从外部存储添加数据](Data_creation_and_modification/Adding_data_from_external_storages.md)
        ...
        * [• 主表+增量表模式](Data_creation_and_modification/Adding_data_from_external_storages/Main_delta.md)
        * [⪢ 从表中添加数据]
...
* [• 更新表结构和设置](Updating_table_schema_and_settings.md)
    * [• 实时模式下更新表结构](Updating_table_schema_and_settings.md#Updating-table-schema-in-RT-mode)
    * [• 实时模式下更新表全文设置](Updating_table_schema_and_settings.md#Updating-table-FT-settings-in-RT-mode)
...
* [⪢ 保护和压缩表]
    ...
    * [• 关于实时表结构的几点说明](Securing_and_compacting_a_table/RT_table_structure.md)
...
* [⪢ 服务器设置]
    ...
    * [• 表与数据源声明的继承](Server_settings/Inheritance_of_index_and_source_declarations.md)
...
* [⪢ 扩展]
    ...
    * [⪢ UDF和插件](Extensions/UDFs_and_Plugins/UDFs_and_Plugins.md)
        ...
        * [⪢ 插件]
            ...
            * [• 启用和禁用助手插件](Extensions/UDFs_and_Plugins/Plugins/Enabling_and_disabling_buddy_plugins.md)
...
* [📖 参考资料](References.md)
    * [• 旧版本文档](References.md#Documentation-for-old-Manticore-versions)
<!-- proofread -->
