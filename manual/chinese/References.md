...
* [ALTER TABLE](Updating_table_schema_and_settings.md) - 修改表结构 / 设置
...
* [ALTER MATERIALIZED VIEW {name} suspended=1](Integration/Kafka.md#Altering-materialized-views) - 暂停或恢复从 Kafka 源消费
...
* [EXPLAIN QUERY](Searching/Full_text_matching/Profiling.md#Profiling-without-running-a-query) - 显示查询执行计划，而不执行查询本身
...
* [SHOW PLAN](Searching/Full_text_matching/Profiling.md#Profiling-the-query-tree-in-SQL) - 查询执行后显示查询执行计划
...
* [FLUSH HOSTNAMES](Securing_and_compacting_a_table/Flushing_hostnames.md) - 更新与代理主机名相关联的 IP
* [FLUSH LOGS](Logging/Rotating_query_and_server_logs.md) - 重新打开 searchd 日志和查询日志文件（类似 USR1 信号）

##### 实时表优化
* [FLUSH RAMCHUNK](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_a_new_disk_chunk.md#FLUSH-RAMCHUNK) - 强制创建新的磁盘块
* [FLUSH TABLE](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_disk.md#FLUSH-TABLE) - 将实时表的内存区块刷新到磁盘
...
* [IMPORT TABLE](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Importing_table.md) - 导入之前创建的 RT 或 PQ 表到运行 RT 模式的服务器
...
##### 普通表旋转
* [重新加载表](Data_creation_and_modification/Adding_data_from_external_storages/Rotating_a_table.md#RELOAD-TABLE) - 旋转普通表
* [重新加载所有表](Data_creation_and_modification/Adding_data_from_external_storages/Rotating_a_table.md#RELOAD-TABLE) - 旋转所有普通表

##### 事务
* [开始](Data_creation_and_modification/Transactions.md#BEGIN,-COMMIT,-and-ROLLBACK) - 开始一个事务
* [提交](Data_creation_and_modification/Transactions.md#BEGIN,-COMMIT,-and-ROLLBACK) - 完成一个事务
* [回滚](Data_creation_and_modification/Transactions.md#BEGIN,-COMMIT,-and-ROLLBACK) - 回滚一个事务

##### 调用
* [调用 SUGGEST，调用 QSUGGEST](Searching/Spell_correction.md#CALL-QSUGGEST,-CALL-SUGGEST) - 提供拼写纠正建议
* [调用 SNIPPETS](Searching/Highlighting.md) - 从提供的数据和查询中构建高亮结果摘要
* [调用 PQ](Searching/Percolate_query.md) - 执行渗透查询
* [调用 KEYWORDS](Searching/Autocomplete.md#CALL-KEYWORDS) - 用于检查关键字如何被分词。也允许检索提供关键字的分词形式
* [调用自动完成](Searching/Autocomplete.md#CALL-AUTOCOMPLETE) - 自动完成搜索查询

##### 插件
* [创建函数](Extensions/UDFs_and_Plugins/UDF/Creating_a_function.md) - 安装用户自定义函数（UDF）
* [删除函数](Extensions/UDFs_and_Plugins/UDF/Deleting_a_function.md) - 删除用户自定义函数（UDF）
* [创建插件](Extensions/UDFs_and_Plugins/Plugins/Creating_a_plugin.md) - 安装插件
* [创建 Buddy 插件](Extensions/UDFs_and_Plugins/Plugins/Creating_a_plugin.md#CREATE-BUDDY-PLUGIN) - 安装 Buddy 插件
* [删除插件](Extensions/UDFs_and_Plugins/Plugins/Deleting_a_plugin.md#DELETE-PLUGIN) - 删除插件
* [删除 Buddy 插件](Extensions/UDFs_and_Plugins/Plugins/Deleting_a_plugin.md#DELETE-BUDDY-PLUGIN) - 删除 Buddy 插件
* [重新加载插件](Extensions/UDFs_and_Plugins/Plugins/Reloading_plugins.md) - 从给定库重新加载所有插件
* [启用 Buddy 插件](Extensions/UDFs_and_Plugins/Plugins/Enabling_and_disabling_buddy_plugins.md#ENABLE-BUDDY-PLUGIN) - 重新激活先前禁用的 Buddy 插件
* [禁用 Buddy 插件](Extensions/UDFs_and_Plugins/Plugins/Enabling_and_disabling_buddy_plugins.md#DISABLE-BUDDY-PLUGIN) - 禁用一个活跃的 Buddy 插件

##### 服务器状态
* [显示状态](Node_info_and_management/Node_status.md#SHOW-STATUS) - 显示多个有用的性能计数器
* [显示线程](Node_info_and_management/SHOW_THREADS.md) - 列出所有当前活跃的客户端线程
* [显示变量](Node_info_and_management/SHOW_VARIABLES.md) - 列出服务器范围内的变量及其值
* [显示版本](Node_info_and_management/SHOW_VERSION.md#SHOW-VERSION) - 提供实例各组件的详细版本信息。
...
* [/bulk](Data_creation_and_modification/Updating_documents/UPDATE.md#Bulk-updates) - 在单次调用中执行多个插入、更新或删除操作。了解更多批量插入内容请查看[这里](Data_creation_and_modification/Adding_documents_to_a_table/Adding_documents_to_a_real-time_table.md)。
...
* ["word1 word2 ... "~N](Searching/Full_text_matching/Operators.md#Proximity-search-operator) - 接近搜索操作符
* ["word1 word2 ... "/N](Searching/Full_text_matching/Operators.md#Quorum-matching-operator) - 法定人数匹配操作符
...
* [word^N](Searching/Full_text_matching/Operators.md#IDF-boost-modifier) - 关键词 IDF 权重提升修饰符
* [word1 NEAR/N word2](Searching/Full_text_matching/Operators.md#NEAR-operator) - NEAR，广义接近操作符
...
* [@@relaxed](Searching/Full_text_matching/Operators.md#Field-search-operator) - 抑制关于缺少字段的错误
...
* [BITDOT()](Functions/Mathematical_functions.md#BITDOT%28%29) - 返回掩码每一位乘以其权重的乘积之和
* [CEIL()](Functions/Mathematical_functions.md#CEIL%28%29) - 返回大于或等于参数的最小整数
...
* [GROUP_CONCAT()](Searching/Grouping.md#GROUP_CONCAT%28field%29) - 生成分组中所有文档属性值的逗号分隔列表
...
* [ZONESPANLIST()](Functions/Searching_and_ranking_functions.md#ZONESPANLIST%28%29) - 返回匹配区域范围的成对列表
* [QUERY()](Functions/Searching_and_ranking_functions.md#QUERY%28%29) - 返回当前全文搜索查询
...
##### 数组与条件
* [ALL()](Functions/Arrays_and_conditions_functions.md#ALL%28%29) - 如果数组中所有元素满足条件，返回1
* [ANY()](Functions/Arrays_and_conditions_functions.md#ANY%28%29) - 如果数组中任何元素满足条件，返回1
* [CONTAINS()](Functions/Arrays_and_conditions_functions.md#CONTAINS%28%29) - 检查点(x,y)是否位于给定多边形内
* [IF()](Functions/Arrays_and_conditions_functions.md#IF%28%29) - 判断第一个参数是否等于0.0，非零时返回第二个参数，零时返回第三个参数
* [IN()](Functions/Arrays_and_conditions_functions.md#IN%28%29) - 如果第一个参数等于其他任一参数，返回1，否则返回0
* [INDEXOF()](Functions/Arrays_and_conditions_functions.md#INDEXOF%28%29) - 遍历数组，返回第一个匹配元素的索引
* [INTERVAL()](Functions/Arrays_and_conditions_functions.md#INTERVAL%28%29) - 返回小于第一个参数的参数的索引
* [LENGTH()](Functions/Arrays_and_conditions_functions.md#LENGTH%28%29) - 返回MVA中元素的数量
* [REMAP()](Functions/Arrays_and_conditions_functions.md#REMAP%28%29) - 根据条件值对表达式值做某些例外处理

##### 日期与时间
* [NOW()](Functions/Date_and_time_functions.md#NOW%28%29) - 返回当前时间戳，类型为INTEGER
* [CURTIME()](Functions/Date_and_time_functions.md#CURTIME%28%29) - 返回本地时区当前时间
* [CURDATE()](Functions/Date_and_time_functions.md#CURDATE%28%29) - 返回本地时区当前日期
* [UTC_TIME()](Functions/Date_and_time_functions.md#UTC_TIME%28%29) - 返回UTC时区当前时间
* [UTC_TIMESTAMP()](Functions/Date_and_time_functions.md#UTC_TIMESTAMP%28%29) - 返回UTC时区当前日期/时间
...
* [DAY()](Functions/Date_and_time_functions.md#DAY%28%29) - 从时间戳参数返回整数天数
...
* [DAYOFWEEK()](Functions/Date_and_time_functions.md#DAYOFWEEK%28%29) - 返回给定时间戳参数的星期索引整数
* [DAYOFYEAR()](Functions/Date_and_time_functions.md#DAYOFYEAR%28%29) - 返回给定时间戳参数的年份中的天数整数
* [YEARWEEK()](Functions/Date_and_time_functions.md#YEARWEEK%28%29) - 返回给定时间戳参数当前周第一天的年份整数和日期代码
* [YEARMONTH()](Functions/Date_and_time_functions.md#YEARMONTH%28%29) - 从时间戳参数返回年份和月份的整数代码
* [YEARMONTHDAY()](Functions/Date_and_time_functions.md#YEARMONTHDAY%28%29) - 从时间戳参数返回年份、月份和日期的整数代码
...
* [POLY2D()](Functions/Geo_spatial_functions.md#POLY2D%28%29) - 在平面空间创建一个简单多边形

##### 字符串
* [CONCAT()](Functions/String_functions.md#CONCAT%28%29) - 连接两个或多个字符串
* [REGEX()](Functions/String_functions.md#REGEX%28%29) - 如果正则表达式匹配属性的字符串则返回1，否则返回0
...
* [LAST_INSERT_ID()](Functions/Other_functions.md#LAST_INSERT_ID%28%29) - 返回当前会话中最后一条语句插入或替换的文档IDs
* [UUID_SHORT()](Functions/Other_functions.md#UUID_SHORT%28%29) - 返回一个“短”通用标识符，遵循与自动ID生成相同的算法。
...
* [json_autoconv_numbers](Server_settings/Common.md#json_autoconv_numbers) - 自动检测并转换可能的表示数字的JSON字符串为数值属性
* [on_json_attr_error](Server_settings/Common.md#on_json_attr_error) - 发现JSON格式错误时的处理方法
...
`indexer` 是一个用来创建 [plain tables](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) 的工具
...
* [max_iosize](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 最大允许的I/O操作大小
...
* [write_buffer](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 写入缓冲区大小
...
* [--buildstops](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 分析表源，仿佛在索引数据，生成索引词列表
* [--buildfreqs](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 为--buildstops添加频率计数到表中
...
* [--dump-rows](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 将SQL源检索的行转储到指定文件
...
* [--merge-killlists](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 合并表时改变kill列表的处理
* [--merge](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 合并两个纯表为一个
...
* [--print-rt](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 显示从SQL源获取的数据作为对实时表的INSERT语句
...
* [--rotate](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 构建完所有表后启动表轮换
* [--sighup-each](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 每个表构建完成后触发其轮换
...
放置于配置文件的 `searchd {}` 部分：
  ...
  * [agent_retry_count](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent_connect_timeout) - 指定 Manticore 尝试连接并查询远程代理的次数
  * [agent_retry_delay](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent) - 在查询远程代理失败时，重试查询的延迟时间
  ...
  * [diskchunk_flush_write_timeout](Server_settings/Searchd.md#diskchunk_flush_write_timeout) - 如果没有写入，自动刷新 RAM 块的超时时间
  * [diskchunk_flush_search_timeout](Server_settings/Searchd.md#diskchunk_flush_search_timeout) - 如果表中没有搜索，防止自动刷新 RAM 块的超时时间
  * [docstore_cache_size](Server_settings/Searchd.md#docstore_cache_size) - 文档存储中文档块在内存中的最大缓存大小
  * [expansion_limit](Creating_a_table/NLP_and_tokenization/Wildcard_searching_settings.md#expansion_limit) - 单个通配符展开的最大关键词数
  * [grouping_in_utc](Server_settings/Searchd.md#grouping_in_utc) - 启用对时间字段进行分组时使用 UTC 时区
  ...
  * [listen_tfo](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent) - 启用所有监听器的 TCP_FASTOPEN 标志
  * [log](Server_settings/Searchd.md#log) - Manticore 服务器日志文件路径
  * [max_batch_queries](Server_settings/Searchd.md#max_batch_queries) - 限制每批次的查询数量
  * [max_connections](Server_settings/Searchd.md#max_connections) - 最大活动连接数
  * [max_filters](Server_settings/Searchd.md#max_filters) - 允许的每个查询的最大过滤器数量
  * [max_filter_values](Server_settings/Searchd.md#max_filter_values) - 允许的每个过滤器的最大值数量
  ...
  * [net_throttle_accept](Server_settings/Searchd.md#net_throttle_accept) - 定义网络循环每次迭代接纳的客户端数量
  ...
  * [persistent_connections_limit](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent) - 允许同时连接到远程持久代理的最大持久连接数
  ...
  * [preopen_tables](Server_settings/Searchd.md#preopen_tables) - 决定是否强制在启动时预打开所有表
  * [pseudo_sharding](Server_settings/Searchd.md#pseudo_sharding) - 启用对普通表和实时表的搜索查询伪分片
  * [qcache_max_bytes](Server_settings/Searchd.md#qcache_max_bytes) - 缓存结果集分配的最大内存
  * [qcache_thresh_msec](Server_settings/Searchd.md#qcache_thresh_msec) - 查询结果缓存的最短墙时阈值
  ...
  * [query_log_min_msec](Server_settings/Searchd.md#query_log_min_msec) - 防止记录过快的查询请求
  * [query_log_mode](Server_settings/Searchd.md#query_log_mode) - 查询日志文件权限模式
  * [read_buffer_docs](Creating_a_table/Local_tables/Plain_and_real-time_table_settings.md#read_buffer_docs) - 针对关键词的文档列表读取缓冲区大小
  * [read_buffer_hits](Creating_a_table/Local_tables/Plain_and_real-time_table_settings.md#read_buffer_docs) - 针对关键词的命中列表读取缓冲区大小
  ...
  * [rt_merge_iops](Server_settings/Searchd.md#rt_merge_iops) - 实时块合并线程允许执行的最大I/O操作数（每秒）
  * [rt_merge_maxiosize](Server_settings/Searchd.md#rt_merge_maxiosize) - 实时块合并线程允许执行的单次最大I/O操作大小
  * [seamless_rotate](Server_settings/Searchd.md#seamless_rotate) - 防止在旋转大数据量表以进行预缓存时searchd停顿
  ...
  * [shutdown_timeout](Server_settings/Searchd.md#shutdown_timeout) - Searchd停止等待超时时间
  * [shutdown_token](Server_settings/Searchd.md#shutdown_token) - 从VIP SQL连接执行`shutdown`命令所需密码的SHA1哈希
  * [snippets_file_prefix](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent) - 在`load_files`模式下生成片段时要加在本地文件名之前的前缀
  * [sphinxql_state](Server_settings/Searchd.md#sphinxql_state) - 当前SQL状态序列化的文件路径
  * [sphinxql_timeout](Server_settings/Searchd.md#sphinxql_timeout) - 等待MySQL客户端请求的最长时间
  ...
  * [thread_stack](Server_settings/Searchd.md#thread_stack) - 作业的最大栈大小
  * [unlink_old](Server_settings/Searchd.md#unlink_old) - 是否在成功旋转后撤销.old表副本链接
  * [watchdog](Server_settings/Searchd.md#watchdog) - 是否启用Manticore服务器看门狗
...
* [--delete](Starting_the_server/Manually.md#searchd-command-line-options) - 从Microsoft管理控制台和服务注册处移除Manticore服务
* [--force-preread](Starting_the_server/Manually.md#searchd-command-line-options) - 防止服务器在表文件预读取完成前接受连接请求
...
* [--install](Starting_the_server/Manually.md#searchd-command-line-options) - 在Microsoft管理控制台安装searchd服务
...
* [--logdebug, --logdebugv, --logdebugvv](Starting_the_server/Manually.md#searchd-command-line-options) - 在服务器日志启用额外的调试输出
* [--logreplication](Starting_the_server/Manually.md#searchd-command-line-options) - 在服务器日志启用额外的复制调试输出
* [--new-cluster](Starting_the_server/Manually.md#searchd-command-line-options) - 初始化复制集群并将服务器设为参考节点，支持[集群重启](Creating_a_cluster/Setting_up_replication/Restarting_a_cluster.md)保护
...
* [--nodetach](Starting_the_server/Manually.md#searchd-command-line-options) - 使 searchd 保持前台运行
...
* [--servicename](Starting_the_server/Manually.md#searchd-command-line-options) - 在安装或删除服务时为 searchd 指定名称，如 Microsoft 管理控制台中显示的名称
...
* [--dumpconfig](Miscellaneous_tools.md#indextool) - 以接近 manticore.conf 格式的方式从给定的表头文件转储表定义
...
* [--docextract](Miscellaneous_tools.md#indextool) - 在整个字典/文档/命中上运行表检查并收集所有属于请求文档的词和命中
* [--fold](Miscellaneous_tools.md#indextool) - 基于表设置测试分词
* [--htmlstrip](Miscellaneous_tools.md#indextool) - 使用指定表的 HTML 剥离器设置过滤标准输入
* [--mergeidf](Miscellaneous_tools.md#indextool) - 将多个 .idf 文件合并为一个文件
* [--morph](Miscellaneous_tools.md#indextool) - 对提供的标准输入应用形态学处理，并输出结果到标准输出
...
* [--apply-killlists](Miscellaneous_tools.md#indextool) - 应用配置文件中列出的所有表的杀死列表
...
##### Wordbreaker 启动参数
* [STDIN](Miscellaneous_tools.md#wordbreaker) - 接受待拆分的字符串
...
* [result](Miscellaneous_tools.md#spelldump) - 指定字典数据输出目标
* [locale-name](Miscellaneous_tools.md#spelldump) - 指定使用的区域设置详情

## 关键词保留列表

Manticore SQL 语法当前保留的关键词的完整字母顺序列表（因此不能作为标识符使用）。
