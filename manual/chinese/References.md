...
* [SHOW PROFILE](Node_info_and_management/Profiling/Query_profile.md) - 显示执行查询的性能分析信息
...
* [--logdebug, --logdebugv, --logdebugvv](Starting_the_server/Manually.md#searchd-command-line-options) - 启用服务器日志的额外调试输出
