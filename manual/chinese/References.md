...
##### 节点管理
* [PURGE](Node_info_and_management/PURGE.md) - 移除与表关联的选定数据
* [PURGE BULK_IMPORT](Node_info_and_management/PURGE.md#PURGE-BULK_IMPORT) - 移除批量导入留下的暂存文件
...
* [--remove_dups](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 以逻辑方式移除重复的数字文档 ID，保留第一行
...
* [29.9.0](https://manual.manticoresearch.com/manticore-29-9-0/)。[安装页面](https://manticoresearch.com/install-29.9.0/)
<!-- proofread -->
