...
* [SHOW PROFILE](Node_info_and_management/Profiling/Query_profile.md) - 显示已执行查询的性能信息
...
* [FLUSH HOSTNAMES](Securing_and_compacting_a_table/Flushing_hostnames.md) - 更新与 agent 主机名相关的 IP
* [FLUSH LOGS](Logging/Rotating_query_and_server_logs.md) - 重新打开 searchd 日志和查询日志文件（类似于 USR1）

##### 实时表优化
* [FLUSH RAMCHUNK](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_a_new_disk_chunk.md#FLUSH-RAMCHUNK) - 强制创建新的磁盘数据块
* [FLUSH TABLE](Securing_and_compacting_a_table/Flushing_RAM_chunk_to_disk.md#FLUSH-TABLE) - 将实时表的 RAM 区块刷新到磁盘
...
* [IMPORT TABLE](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Importing_table.md) - 导入先前创建的 RT 或 PQ 表到以 RT 模式运行的服务器
...
* [DELETE CLUSTER](Creating_a_cluster/Setting_up_replication/Deleting_a_replication_cluster.md) - 删除一个复制集群
...
##### CALL
* [CALL SUGGEST, CALL QSUGGEST](Searching/Spell_correction.md#CALL-QSUGGEST,-CALL-SUGGEST) - 建议拼写修正的单词
* [CALL SNIPPETS](Searching/Highlighting.md) - 从提供的数据和查询构建高亮结果片段
* [CALL PQ](Searching/Percolate_query.md) - 运行一个渗透查询
* [CALL KEYWORDS](Searching/Autocomplete.md#CALL-KEYWORDS) - 用于检查关键词如何被分词。还允许检索所提供关键词的分词形式
* [CALL AUTOCOMPLETE](Searching/Autocomplete.md#CALL-AUTOCOMPLETE) - 自动补全搜索查询

##### 插件
* [CREATE FUNCTION](Extensions/UDFs_and_Plugins/UDF/Creating_a_function.md) - 安装一个用户自定义函数（UDF）
* [DROP FUNCTION](Extensions/UDFs_and_Plugins/UDF/Deleting_a_function.md) - 删除一个用户自定义函数（UDF）
...
* [DISABLE BUDDY PLUGIN](Extensions/UDFs_and_Plugins/Plugins/Enabling_and_disabling_buddy_plugins.md#DISABLE-BUDDY-PLUGIN) - 禁用一个激活的Buddy插件
...
* [/bulk](Data_creation_and_modification/Updating_documents/UPDATE.md#Bulk-updates) - 在一次调用中执行多个插入、更新或删除操作。关于批量插入的更多信息请参见[这里](Data_creation_and_modification/Adding_documents_to_a_table/Adding_documents_to_a_real-time_table.md)。
...
* [/tbl_name/_mapping](Creating_a_table/Local_tables/Real-time_table.md#_mapping-API:) - 以Elasticsearch风格创建表结构
...
* [word1 PARAGRAPH word2 PARAGRAPH "word3 word4"](Searching/Full_text_matching/Operators.md#SENTENCE-and-PARAGRAPH-operators) - 段落（PARAGRAPH）操作符
* [word1 SENTENCE word2 SENTENCE "word3 word4"](Searching/Full_text_matching/Operators.md#SENTENCE-and-PARAGRAPH-operators) - 句子（SENTENCE）操作符
* [ZONE:(h3,h4)](Searching/Full_text_matching/Operators.md#ZONE-limit-operator) - ZONE 限定操作符
* [ZONESPAN:(h2)](Searching/Full_text_matching/Operators.md#ZONESPAN-limit-operator) - ZONESPAN 限定操作符
* [@@relaxed](Searching/Full_text_matching/Operators.md#Field-search-operator) - 抑制缺失字段的错误
* [t?st](Searching/Full_text_matching/Operators.md#Wildcard-operators) - 通配符操作符
* [REGEX(/pattern/)](Searching/Full_text_matching/Operators.md#REGEX-operator) - 正则表达式（REGEX）操作符

## Functions
##### Mathematical
* [ABS()](Functions/Mathematical_functions.md#ABS%28%29) - 返回绝对值
* [ATAN2()](Functions/Mathematical_functions.md#ATAN2%28%29) - 返回两个参数的反正切值
* [BITDOT()](Functions/Mathematical_functions.md#BITDOT%28%29) - 返回掩码每个位乘以其权重的乘积之和
...
* [ANY()](Functions/Arrays_and_conditions_functions.md#ANY%28%29) - 如果条件对数组中的任意元素为真，则返回1
* [CONTAINS()](Functions/Arrays_and_conditions_functions.md#CONTAINS%28%29) - 检查点(x,y)是否位于给定多边形内
* [IF()](Functions/Arrays_and_conditions_functions.md#IF%28%29) - 检查第一个参数是否等于0.0，如果不为零则返回第二个参数，否则返回第三个参数
* [IN()](Functions/Arrays_and_conditions_functions.md#IN%28%29) - 如果第一个参数等于其他参数中的任意值，则返回1，否则返回0
...
* [REMAP()](Functions/Arrays_and_conditions_functions.md#REMAP%28%29) - 根据条件值允许对表达式值进行某些例外处理
...
* [DAYOFYEAR()](Functions/Date_and_time_functions.md#DAYOFYEAR%28%29) - 返回给定时间戳参数的整数年日
* [YEARWEEK()](Functions/Date_and_time_functions.md#YEARWEEK%28%29) - 返回给定时间戳参数当前周第一天的整数年份和日代码
...
* [POLY2D()](Functions/Geo_spatial_functions.md#POLY2D%28%29) - 创建一个平面空间中的简单多边形

##### 字符串
* [CONCAT()](Functions/String_functions.md#CONCAT%28%29) - 连接两个或多个字符串
* [REGEX()](Functions/String_functions.md#REGEX%28%29) - 如果正则表达式匹配属性字符串返回1，否则返回0
...
## 配置文件中的常用设置
放入配置文件的 `common {}` 部分：
* [lemmatizer_base](Server_settings/Common.md#lemmatizer_base) - 词形还原字典基础路径
...
* [plugin_dir](Server_settings/Common.md#plugin_dir) - 动态库和用户自定义函数（UDF）的存放位置
...
* [mem_limit](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 索引使用的内存限制
...
* [--buildstops](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 分析表源，仿索引数据，生成索引词列表
* [--buildfreqs](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 为--buildstops添加词频统计
...
* [--dump-rows](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 将通过SQL源检索的行转储到指定文件
...
* [--keep-attrs](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 重新索引时允许重复使用已有属性
* [--keep-attrs-names](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 指定从现有表复用的属性名称
* [--merge-dst-range](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 合并时应用指定的过滤范围
* [--merge-killlists](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 合并表时修改kill列表的处理方式
...
* [--nohup](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 启用此选项时，防止索引器发送SIGHUP信号
...
* [--print-queries](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 输出索引器向数据库发送的SQL查询
* [--print-rt](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 显示从SQL源获取的数据，作为实时表的INSERT语句
...
* [--rotate](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - 在构建所有表后启动表轮换
...
`index_converter` 是一个用于将Sphinx/Manticore Search 2.x创建的表转换为Manticore Search 3.x表格式的工具。
```bash
...
* [--killlist-target](Installation/Migration_from_Sphinx.md#index_converter) - 设定应用kill-list的目标表

## [Searchd](Starting_the_server/Manually.md)
`searchd` 是Manticore服务器。
...
放置在配置文件的 `searchd {}` 部分：
  ...
  * [agent_retry_delay](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent) - 在查询远程代理失败后重试的延迟时间
  ...
  * [data_dir](Server_settings/Searchd.md#data_dir) - Manticore 存储所有内容的数据目录路径 ([RT mode](Creating_a_table/Local_tables.md#Online-schema-management-%28RT-mode%29))
  * [diskchunk_flush_write_timeout](Server_settings/Searchd.md#diskchunk_flush_write_timeout) - 如果没有写操作，自动刷新 RAM 块的超时时间
  * [diskchunk_flush_search_timeout](Server_settings/Searchd.md#diskchunk_flush_search_timeout) - 如果表中没有搜索，防止自动刷新 RAM 块的超时时间
  * [docstore_cache_size](Server_settings/Searchd.md#docstore_cache_size) - 内存中缓存的文档存储文档块最大大小
  * [expansion_limit](Creating_a_table/NLP_and_tokenization/Wildcard_searching_settings.md#expansion_limit) - 单个通配符展开的最大关键字数
  ...
  * [jobs_queue_size](Server_settings/Searchd.md#jobs_queue_size) - 定义队列中同时允许的“作业”最大数量
  ...
  * [kibana_version_string](Server_settings/Searchd.md#kibana_version_string) – 服务器版本字符串，响应 Kibana 请求时发送
  ...
  * [max_batch_queries](Server_settings/Searchd.md#max_batch_queries) - 限制每个批处理的查询数量
  ...
  * [net_wait_tm](Server_settings/Searchd.md#net_wait_tm) - 控制网络线程的忙轮询间隔
  ...
  * [persistent_connections_limit](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent) - 对远程持久代理的最大同时持久连接数
  ...
  * [pseudo_sharding](Server_settings/Searchd.md#pseudo_sharding) - 启用针对于普通和实时表的搜索查询的伪分片
  * [qcache_max_bytes](Server_settings/Searchd.md#qcache_max_bytes) - 为缓存的结果集分配的最大内存
  ...
  * [read_buffer_docs](Creating_a_table/Local_tables/Plain_and_real-time_table_settings.md#read_buffer_docs) - 每个关键字文档列表的读取缓冲区大小
  * [read_buffer_hits](Creating_a_table/Local_tables/Plain_and_real-time_table_settings.md#read_buffer_docs) - 每个关键字命中列表的读取缓冲区大小
  * [read_unhinted](Server_settings/Searchd.md#read_unhinted) - 无提示读取大小
  * [rt_flush_period](Server_settings/Searchd.md#rt_flush_period) - Manticore 将实时表的内存块刷新到磁盘的频率
  * [rt_merge_iops](Server_settings/Searchd.md#rt_merge_iops) - 实时块合并线程允许执行的最大I/O 操作数（每秒）
  * [rt_merge_maxiosize](Server_settings/Searchd.md#rt_merge_maxiosize) - 实时块合并线程允许执行的最大单次I/O 操作大小
  * [seamless_rotate](Server_settings/Searchd.md#seamless_rotate) - 防止在旋转带有大量数据的表以进行预缓存时，searchd 停顿
  * [secondary_indexes](Server_settings/Searchd.md#secondary_indexes) - 启用对搜索查询使用辅助索引
  ...
  * [shutdown_token](Server_settings/Searchd.md#shutdown_token) - 从VIP SQL连接调用 `shutdown` 命令所需密码的SHA1哈希值
  ...
  * [sphinxql_state](Server_settings/Searchd.md#sphinxql_state) - 当前SQL状态序列化文件的路径
  * [sphinxql_timeout](Server_settings/Searchd.md#sphinxql_timeout) - 等待来自MySQL客户端的请求的最长时间
  * [ssl_ca](Server_settings/Searchd.md#ssl_ca) - SSL 证书颁发机构证书文件路径
  * [ssl_cert](Server_settings/Searchd.md#ssl_cert) - 服务器的SSL证书路径
  * [ssl_key](Server_settings/Searchd.md#ssl_key) - 服务器的SSL证书密钥路径
  ...
  * [unlink_old](Server_settings/Searchd.md#unlink_old) - 成功旋转后是否取消链接 .old 表副本
...
* [--force-preread](Starting_the_server/Manually.md#searchd-command-line-options) - 阻止服务器在表文件预读取完成之前提供服务
...
* [--install](Starting_the_server/Manually.md#searchd-command-line-options) - 在Microsoft管理控制台中安装searchd为服务
...
* [--logdebug, --logdebugv, --logdebugvv](Starting_the_server/Manually.md#searchd-command-line-options) - 在服务器日志中启用额外调试输出
...
* [--new-cluster-force](Starting_the_server/Manually.md#searchd-command-line-options) - 初始化复制集群并将服务器设置为参考节点，跳过 [集群重启](Creating_a_cluster/Setting_up_replication/Restarting_a_cluster.md) 保护
...
* [--servicename](Starting_the_server/Manually.md#searchd-command-line-options) - 在安装或删除服务时为 searchd 指定名称，名称显示在 Microsoft 管理控制台中
* [--status](Starting_the_server/Manually.md#searchd-command-line-options) - 查询正在运行的搜索服务并返回其状态
...
* [--quiet, -q](Miscellaneous_tools.md#indextool) - 使 indextool 保持安静；无横幅输出等
...
* [--dumpconfig](Miscellaneous_tools.md#indextool) - 从给定的表头文件转储表定义，格式几乎符合 manticore.conf
* [--dumpheader](Miscellaneous_tools.md#indextool) - 通过表名转储表头，同时在配置文件中查找头文件路径
...
* [--docextract](Miscellaneous_tools.md#indextool) - 对整个字典/文档/命中运行表检查，收集指定文档的所有词和命中
* [--fold](Miscellaneous_tools.md#indextool) - 基于表设置测试分词
* [--htmlstrip](Miscellaneous_tools.md#indextool) - 使用指定表的 HTML 剥离设置过滤 STDIN
* [--mergeidf](Miscellaneous_tools.md#indextool) - 合并多个 .idf 文件为一个单一文件
* [--morph](Miscellaneous_tools.md#indextool) - 对提供的 STDIN 应用形态学处理，并将结果输出到 stdout
...
* [--rotate](Miscellaneous_tools.md#indextool) - 使用 `--check` 时，确定是否检查等待轮换的表
* [--apply-killlists](Miscellaneous_tools.md#indextool) - 应用配置文件中列出的所有表的 kill-list
...
Manticore SQL 语法中当前保留的关键字完整的字母排序列表（因此不能用作标识符）。
