...
This release adds chunked and multi-vector auto-embeddings, safe UTF-8 identifiers, configurable embedding input limits, German sharp-s normalization, richer `manticore-load` benchmarking, and authenticated cloud-aware backups, with fixes across KNN, hybrid and grouped search, schema changes, bulk ingestion, replication, binlog recovery, compatibility, and shutdown behavior.
