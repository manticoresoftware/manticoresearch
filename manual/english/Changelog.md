...
This release brings built-in authentication and authorization, sharded tables, faster HNSW builds, better faceting and aggregations, and a long list of fixes across KNN, replication, protocol compatibility and other areas.
...
* 🆕 [v25.11.0](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.11.0) [ PR #4558](https://github.com/manticoresoftware/manticoresearch/pull/4558) Updated Buddy to 3.46.0, adding conversational RAG / chat search support.
