...
Этот выпуск добавляет просмотр настроек шардированных таблиц, оптимизацию распределённых и шардированных таблиц, callback'и Buddy через Unix-сокеты, более надёжный разговорный поиск, настраиваемый доступ к файлам и более быстрое columnar KNN-пересчитывание ранжирования, а также исправления в подсветке, инспекции запросов, KNN-компакции, использовании памяти распределёнными запросами, таблицах-шаблонах и одновременной оптимизации RT-таблиц.
