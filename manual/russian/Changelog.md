...
В этом выпуске добавлены фрагментированные и многовекторные автоэмбеддинги, безопасные UTF-8-идентификаторы, настраиваемые лимиты входных данных для эмбеддингов, нормализация немецкой sharp-s, расширенные бенчмарки в `manticore-load` и облачные резервные копии с аутентификацией, а также исправления в KNN, гибридном и сгруппированном поиске, изменениях схемы, пакетной загрузке данных, репликации, восстановлении binlog, совместимости и поведении при завершении работы.
