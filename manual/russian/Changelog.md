...
* 🆕 [v26.1.0](https://github.com/manticoresoftware/manticoresearch/releases/tag/26.1.0) [ PR #4537](https://github.com/manticoresoftware/manticoresearch/pull/4537) Добавлены нативные таблицы `type='sharding'` с распределенными вставками, а также крупные улучшения шардинга: создание, маршрутизация, откат, отказоустойчивость и эксплуатационное поведение.
...
* 🆕 [v25.8.0](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.8.0) [ PR #4414](https://github.com/manticoresoftware/manticoresearch/pull/4414) Добавлен встроенный украинский лемматизатор, расширяющий нативную поддержку морфологии для поиска по украинскому тексту.
* 🆕 [v25.7.18](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.7.18) [ Issue #4461](https://github.com/manticoresoftware/manticoresearch/issues/4461) Добавлена поддержка `time_zone` и `offset` для [`date_histogram`](Functions/Date_and_time_functions.md#DATE_HISTOGRAM%28%29), что делает возможной привязку календарных интервалов к часовым поясам в агрегатных запросах.
...
* 🆕 [v25.6.0](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.6.0) [ PR #4407](https://github.com/manticoresoftware/manticoresearch/pull/4407) Расширен [`bm25a()`](Functions/Searching_and_ranking_functions.md#BM25A%28%29) в ранкере `expr`: теперь он принимает необязательный третий аргумент `avgdl`, что позволяет запросам переопределять среднюю длину документа, используемую в оценке BM25A.
...
* 🆕 [v25.0.5](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.0.5) [ Issue #1514](https://github.com/manticoresoftware/manticoresearch/issues/1514) Добавлен [`EXIT CLUSTER`](Creating_a_cluster/Setting_up_replication/Managing_replication_nodes.md#EXIT-CLUSTER), позволяющий текущему узлу онлайн отсоединиться от репликационного кластера без перезапуска демона, сохраняя локальные таблицы как обычные локальные таблицы.

## Ломающие изменения
* ⚠️ **26.0.0** [ Issue #4431](https://github.com/manticoresoftware/manticoresearch/issues/4431) [ PR #4598](https://github.com/manticoresoftware/manticoresearch/pull/4598) **Ломающее изменение**: входящие реплицируемые таблицы теперь хранятся в обычной структуре [`data_dir`](Server_settings/Searchd.md#data_dir)/`<table>`, а не в кластерном `path`. Это затрагивает вас, если вы используете **репликационные кластеры** с пользовательским `path`: в более старых версиях полученные файлы реплицируемых таблиц могли попадать в каталог кластера, поэтому после обновления может потребоваться переместить или повторно синхронизировать эти таблицы в стандартную структуру `data_dir`. Откат безопасен только до перехода на новый формат реплицируемых таблиц.
...
* 🪲 [v25.7.17](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.7.17) [ PR #4529](https://github.com/manticoresoftware/manticoresearch/pull/4529) Включено несколько мелких исправлений и чисток, включая еще одно исправление корректности [`ATTACH TABLE`](Data_creation_and_modification/Adding_data_from_external_storages/Adding_data_to_tables/Attaching_one_table_to_another.md) и небольшие улучшения runtime/build.
...
* 🪲 [v25.7.2](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.7.2) [ Issue #4491](https://github.com/manticoresoftware/manticoresearch/issues/4491) Исправлено состояние вторичных индексов после переименования RT-чанка и [`OPTIMIZE`](Securing_and_compacting_a_table/Compacting_a_table.md#OPTIMIZE-TABLE), чтобы индексы, отключенные через [`UPDATE`](Data_creation_and_modification/Updating_documents/UPDATE.md), оставались отключенными после перезапуска демона и не включались снова случайно.
...
* 🪲 [v25.6.4](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.6.4) [ Issue #4469](https://github.com/manticoresoftware/manticoresearch/issues/4469) Исправлен [`ALTER TABLE ... REBUILD SECONDARY`](Updating_table_schema_and_settings.md#Rebuilding-a-secondary-index) после слияния RT disk chunk через [`OPTIMIZE`](Securing_and_compacting_a_table/Compacting_a_table.md#OPTIMIZE-TABLE), чтобы файлы вторичных индексов оставались синхронизированы с переименованными оптимизированными chunk и больше не завершались ошибкой `secondary index file ... not loaded`.
...
* 🪲 [v25.5.1](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.5.1) [ Issue #4444](https://github.com/manticoresoftware/manticoresearch/issues/4444) Исправлен crash в expr-ranker при использовании [`bm25a()`](Functions/Searching_and_ranking_functions.md#BM25A%28%29) или [`bm25f()`](Functions/Searching_and_ranking_functions.md#BM25F%28%29) на columnar-таблицах с [`index_field_lengths`](Creating_a_table/NLP_and_tokenization/Low-level_tokenization.md#index_field_lengths)='1', чтобы пользовательское ранжирование больше не разыменовывало атрибуты длины поля из неверного хранилища.
...
* 🪲 [v25.0.2](https://github.com/manticoresoftware/manticoresearch/releases/tag/25.0.2) [ Issue #4395](https://github.com/manticoresoftware/manticoresearch/issues/4395) Исправлен [`OPTIMIZE TABLE ... OPTION sync=1, cutoff=N`](Securing_and_compacting_a_table/Compacting_a_table.md#OPTIMIZE-TABLE) при уже запущенной автооптимизации, так что ручной запрос optimize теперь ждет достижения своего целевого сокращения чанков вместо привязки к другой текущей операции optimize.
