...
В стандартном SQL-синтаксисе Manticore [MVA](../Data_types.md#Multi-value-integer-%28MVA%29) или [векторы с плавающей запятой](../Creating_a_table/Data_types.md#Float-vector) записываются как список значений в круглых скобках, например `(1, 2, 3)`.
