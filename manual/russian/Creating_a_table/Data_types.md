...
Имена таблиц ограничены 207 байтами UTF-8 как в режиме RT, так и в режиме Plain. Для полных имен таблиц `system.` префикс учитывается в этом лимите. Ограничение также применяется при загрузке существующих определений таблиц, поэтому перед обновлением переименуйте все более длинные таблицы.
