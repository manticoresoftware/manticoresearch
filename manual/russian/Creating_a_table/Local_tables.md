...
Латинские буквы в именах таблиц при создании приводятся к нижнему регистру. Не-ASCII символы UTF-8 сохраняют исходное написание и не проходят Unicode case folding. См. [синтаксис имен таблиц, полей и атрибутов](Data_types.md#Table-and-field-name-syntax).
...
В этом режиме имена секций конфигурации чувствительны к регистру. Имена таблиц, полей и атрибутов, а также именованные секции источников, могут содержать не-ASCII символы UTF-8. Unicode case folding и Unicode normalization не применяются, поэтому используйте точное написание Unicode последовательно. См. [синтаксис имен таблиц, полей и атрибутов](Data_types.md#Table-and-field-name-syntax).
