...
Это создает таблицу "products" с двумя полями: "title" (полнотекстовый) и "price" (float), и устанавливает "морфологию" (morphology) как "stem_en".
...
* "title" индексируется, но не хранится.
* "description" хранится, но не индексируется.
* "author" хранится и индексируется.
