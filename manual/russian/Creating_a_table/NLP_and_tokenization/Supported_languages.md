...
| Украинский | charset_table=non_cont,U+0406->U+0456,U+0456,U+0407->U+0457,U+0457,U+0490->U+0491,U+0491 | - | morphology=lemmatize_uk (одна основная форма); morphology=lemmatize_uk_all (все основные формы) | Переопределите `charset_table`, чтобы сохранить `і`, `ї` и `ґ` |
