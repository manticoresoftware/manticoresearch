...
Такая структура гарантирует, что сгенерированные ID уникальны среди узлов кластера и что данные, вставленные в разные узлы, не создают коллизий между ними.
