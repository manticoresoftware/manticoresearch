...
Для включения поддержки токенизации CJK официальные пакеты содержат бинарные файлы с встроенной библиотекой ICU и включают файл данных ICU. Они независимы от любой ICU runtime-библиотеки, которая может быть установлена в вашей системе, и не могут быть обновлены.
