...
Начиная с версии 25.0.0, `manticore` — это единый пакет. Он уже включает Manticore Buddy, Manticore Columnar Library (колоночное хранение, вторичные индексы, KNN-поиск и автоматические эмбеддинги), backup, load и Galera, поэтому устанавливать другие пакеты `manticore-*` не нужно.
