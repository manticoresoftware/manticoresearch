...
Для полностью предварительно настроенной конфигурации запустите универсальный Docker-образ из репозитория с Grafana и Prometheus, адаптированными для мониторинга Manticore. Это идеальный вариант, если у вас нет существующей настройки или вы хотите быстро протестировать окружение:
