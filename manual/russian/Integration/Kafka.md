...
- **Группировка:** Сообщения группируются в партии для эффективной обработки. Размер партии можно настроить под ваши требования к производительности и задержкам.
- **Буферизация:** Партии отображённых данных сохраняются в буферной таблице для эффективных пакетных операций.
