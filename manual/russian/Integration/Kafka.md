...
Manticore поддерживает интеграцию с [Apache Kafka](https://kafka.apache.org/) для потокового приема данных в реальном времени через источники Kafka и материальные представления, что позволяет выполнять индексирование и поиск данных в реальном времени. В настоящее время протестированы и поддерживаются версии **apache/kafka 3.7.0-4.0.0**.
