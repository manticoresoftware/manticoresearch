...
* [🔰 Краткое руководство по началу работы](Quick_start_guide.md)
...
* [3️⃣ Создание таблицы](Creating_a_table.md)
    ...
    * [≫ Создание локальной таблицы](Creating_a_table/Local_tables.md)
        ...
        * [• Настройки обычных таблиц и таблиц реального времени](Creating_a_table/Local_tables/Plain_and_real-time_table_settings.md)
...
* [5️⃣ Поиск]
    ...
    * [≫ Полнотекстовое соответствие]
        * [• Основы использования](Searching/Full_text_matching/Basic_usage.md)
    ...
    * [• Сравнение строк](Searching/Collations.md)
    * [• Оптимизатор на основе стоимости](Searching/Cost_based_optimizer.md)
    * [• Поиск ближайших соседей по вектору (KNN)](Searching/KNN.md)
...
* [≫ Защита и оптимизация таблицы]
    ...
    * [• Оптимизация таблицы](Securing_and_compacting_a_table/Compacting_a_table.md)
