...
* [3️⃣ Создание таблицы](Creating_a_table.md)
    * [⪢ Типы данных](Creating_a_table/Data_types.md)
        * [• Построчное и поколоночное хранение атрибутов](Creating_a_table/Data_types.md#Row-wise-and-columnar-attribute-storages)
    * [⪢ Создание локальной таблицы](Creating_a_table/Local_tables.md)
        ...
        * [• Настройки простых и реальных таблиц](Creating_a_table/Local_tables/Plain_and_real-time_table_settings.md)
...
* [⪢ Создание кластера](Creating_a_cluster/Creating_a_cluster.md)
    ...
    * [⪢ Удалённые узлы](Creating_a_cluster/Remote_nodes.md)
        * [Отражение (Mirroring)](Creating_a_cluster/Remote_nodes/Mirroring.md)
    ...
    * [⪢ Настройка репликации](Creating_a_cluster/Setting_up_replication/Setting_up_replication.md)
        ...
        * [Добавление и удаление таблиц из кластера репликации](Creating_a_cluster/Setting_up_replication/Adding_and_removing_a_table_from_a_replication_cluster.md)
...
* [5️⃣ Поиск]
    ...
    * [• Перколят запрос](Searching/Percolate_query.md)
    ...
    * [• Поиск векторов ближайших соседей (KNN)](Searching/KNN.md)
...
* [⪢ Обеспечение безопасности и уплотнение таблицы]
    ...
    * [• Сброс хостнеймов](Securing_and_compacting_a_table/Flushing_hostnames.md)
* [⪢ Безопасность]
    * [• SSL](Security/SSL.md)
...
* [⪢ Информация о ноде и управление]
...
* [⪢ Настройки сервера]
    ...
    * [• Онлайн настройка переменных](Server_settings/Setting_variables_online.md)
* [⪢ Интеграция]
...
* [• Разные утилиты](Miscellaneous_tools.md)
