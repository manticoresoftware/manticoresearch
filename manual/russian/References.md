...
* [SHOW PROFILE](Node_info_and_management/Profiling/Query_profile.md) - Показывает информацию профилирования выполненного запроса
...
* [SQRT()](Functions/Mathematical_functions.md#SQRT%28%29) - Возвращает квадратный корень из аргумента
...
* [GROUP_CONCAT()](Searching/Grouping.md#GROUP_CONCAT%28field%29) - Формирует список значений атрибута всех документов в группе, разделённых запятыми
...
* [UINT()](Functions/Type_casting_functions.md#UINT%28%29) - Преобразует данный аргумент в 32-битное беззнаковое целое число
* [UINT64()](Functions/Type_casting_functions.md#UINT64%28%29) - Преобразует данный аргумент в 64-битное беззнаковое целое число
...
* [REMAP()](Functions/Arrays_and_conditions_functions.md#REMAP%28%29) - Позволяет делать исключения из значений выражения в зависимости от значений условий
...
* [SECOND()](Functions/Date_and_time_functions.md#SECOND%28%29) - Возвращает целочисленное значение секунд из аргумента метки времени
* [MINUTE()](Functions/Date_and_time_functions.md#MINUTE%28%29) - Возвращает целочисленное значение минут из аргумента метки времени
...
* [json_autoconv_keynames](Server_settings/Common.md#json_autoconv_keynames) - Включение и способ автоконвертации имен ключей в JSON-атрибутах
* [json_autoconv_numbers](Server_settings/Common.md#json_autoconv_numbers) - Автоматически обнаруживает и конвертирует возможные JSON-строки, представляющие числа, в числовые атрибуты
...
* [max_file_field_buffer](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - Максимальный адаптивный буфер для файлового поля
...
* [--nohup](Data_creation_and_modification/Adding_data_from_external_storages/Plain_tables_creation.md#Indexer-command-line-arguments) - Предотвращает отправку SIGHUP индексатором при включении этой опции
...
Должны быть помещены в секцию `searchd {}` файла конфигурации:
  ...
  * [agent_retry_count](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent_connect_timeout) - Задает количество попыток подключения и запроса к удалённым агентам в Manticore
  * [agent_retry_delay](Creating_a_table/Creating_a_distributed_table/Remote_tables.md#agent) - Задает задержку перед повторной попыткой запроса к удалённому агенту в случае сбоя
  ...
  * [data_dir](Server_settings/Searchd.md#data_dir) - Путь к каталогу с данными, где Manticore хранит все данные ([RT режим](Creating_a_table/Local_tables.md#Online-schema-management-%28RT-mode%29))
  * [diskchunk_flush_write_timeout](Server_settings/Searchd.md#diskchunk_flush_write_timeout) - Таймаут авто-сброса RAM чанка, если в него не производятся записи
  * [diskchunk_flush_search_timeout](Server_settings/Searchd.md#diskchunk_flush_search_timeout) - Таймаут предотвращающий авто-сброс RAM чанка, если в таблице нет поисковых запросов
  ...
  * [expansion_limit](Creating_a_table/NLP_and_tokenization/Wildcard_searching_settings.md#expansion_limit) - Максимальное количество расширенных ключевых слов для одного шаблона с подстановочными знаками
  ...
  * [jobs_queue_size](Server_settings/Searchd.md#jobs_queue_size) - Определяет максимальное количество "заданий" одновременно в очереди
  * [join_batch_size](Searching/Joining.md#Join-batching) - Определяет размер пакета для объединения таблиц для баланса между производительностью и использованием памяти
  ...
  * [listen](Server_settings/Searchd.md#listen) - Задает IP-адрес и порт или путь Unix-сокета для прослушивания searchd
  * [listen_backlog](Server_settings/Searchd.md#listen_backlog) - Размер очереди входящих TCP-соединений
  ...
  * [max_batch_queries](Server_settings/Searchd.md#max_batch_queries) - Ограничение числа запросов в одном пакете
  * [max_connections](Server_settings/Searchd.md#max_connections) - Максимальное число активных подключений
  * [max_filters](Server_settings/Searchd.md#max_filters) - Максимальное разрешённое количество фильтров на запрос
  * [max_filter_values](Server_settings/Searchd.md#max_filter_values) - Максимальное разрешённое количество значений на фильтр
  ...
  * [max_packet_size](Server_settings/Searchd.md#max_packet_size) - Максимальный разрешённый размер сетевого пакета
  ...
  * [net_wait_tm](Server_settings/Searchd.md#net_wait_tm) - Управляет интервалом busy loop для сетевого потока
  ...
  * [parallel_chunk_merges](Server_settings/Searchd.md#parallel_chunk_merges) - Сколько слияний дисковых чанков RT может выполняться параллельно во время OPTIMIZE
  ...
  * [preopen_tables](Server_settings/Searchd.md#preopen_tables) - Определяет, нужно ли принудительно предварительно открывать все таблицы при запуске
  * [pseudo_sharding](Server_settings/Searchd.md#pseudo_sharding) - Включает псевдо-шардинг для поисковых запросов к обычным и реальным таблицам
  ...
  * [qcache_thresh_msec](Server_settings/Searchd.md#qcache_thresh_msec) - Минимальный порог времени выполнения запроса для его кэширования
  * [qcache_ttl_sec](Server_settings/Searchd.md#qcache_ttl_sec) - Время жизни кэшированного набора результатов
  * [query_log](Server_settings/Searchd.md#query_log) - Путь к файлу лога запросов
  * [query_log_format](Server_settings/Searchd.md#query_log_format) - Формат лога запросов
  * [query_log_min_msec](Server_settings/Searchd.md#query_log_min_msec) - Предотвращает логирование слишком быстрых запросов
  * [query_log_mode](Server_settings/Searchd.md#query_log_mode) - Режим прав доступа к файлу лога запросов
  ...
  * [rt_flush_period](Server_settings/Searchd.md#rt_flush_period) - Как часто Manticore сбрасывает в память на диске части real-time таблиц
  * [rt_merge_iops](Server_settings/Searchd.md#rt_merge_iops) - Максимальное количество операций ввода-вывода (в секунду), которое разрешено выполнять потоку слияния реальных частей таблиц
  * [rt_merge_maxiosize](Server_settings/Searchd.md#rt_merge_maxiosize) - Максимальный размер операции ввода-вывода, допустимый для потока слияния реальных частей таблиц
  * [seamless_rotate](Server_settings/Searchd.md#seamless_rotate) - Предотвращение зависаний searchd при ротации таблиц с огромными объемами данных для предварительного кэширования
  ...
  * [server_id](Server_settings/Searchd.md#server_id) - Идентификатор сервера, используемый как семя для генерации уникального ID документа
  ...
  * [timezone](Server_settings/Searchd.md#timezone) - Часовой пояс, используемый функциями даты/времени
  * [thread_stack](Server_settings/Searchd.md#thread_stack) - Максимальный размер стека для задачи
  * [unlink_old](Server_settings/Searchd.md#unlink_old) - Нужно ли удалять старые копии таблиц .old при успешной ротации
  * [watchdog](Server_settings/Searchd.md#watchdog) - Включить или отключить наблюдатель сервера Manticore
...
* [--console](Starting_the_server/Manually.md#searchd-command-line-options) - Принудительный запуск сервера в консольном режиме
* [--coredump](Starting_the_server/Manually.md#searchd-command-line-options) - Включает сохранение дампа памяти при сбое
* [--cpustats](Starting_the_server/Manually.md#searchd-command-line-options) - Включает отчет по использованию CPU
...
* [--force-preread](Starting_the_server/Manually.md#searchd-command-line-options) - Запрещает серверу обслуживать входящие подключения до предчтения файлов таблиц
...
* [--dumpconfig](Miscellaneous_tools.md#indextool) - Выводит определение таблицы из указанного заголовочного файла в формате, близком к manticore.conf
...
* [--rotate](Miscellaneous_tools.md#indextool) - Определяет, следует ли проверять таблицу в ожидании ротации при использовании `--check`
