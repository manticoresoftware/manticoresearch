...
Должны быть помещены в секцию `searchd {}` файла конфигурации:
  ...
  * [diskchunk_flush_write_timeout](Server_settings/Searchd.md#diskchunk_flush_write_timeout) - Таймаут для автоматического сброса RAM-чанка, если в него не происходит запись
  * [diskchunk_flush_search_timeout](Server_settings/Searchd.md#diskchunk_flush_search_timeout) - Таймаут для предотвращения автоматического сброса RAM-чанка, если в таблице не выполняются поиски
  ...
  * [listen](Server_settings/Searchd.md#listen) - Указывает IP-адрес и порт или путь к Unix-доменному сокету, на которых searchd слушает
  ...
  * [max_filter_values](Server_settings/Searchd.md#max_filter_values) - Максимально допустимое количество значений в фильтре
  ...
  * [predicted_time_costs](Server_settings/Searchd.md#predicted_time_costs) - Затраты для модели предсказания времени запроса
  ...
  * [qcache_ttl_sec](Server_settings/Searchd.md#qcache_ttl_sec) - Период хранения кэшированного набора результатов
  ...
  * [rt_flush_period](Server_settings/Searchd.md#rt_flush_period) - Как часто Manticore сбрасывает в диск RAM-чонки реальных таблиц
  * [rt_merge_iops](Server_settings/Searchd.md#rt_merge_iops) - Максимальное количество операций ввода-вывода (в секунду), разрешенных для потока слияния чанков реального времени
  ...
  * [seamless_rotate](Server_settings/Searchd.md#seamless_rotate) - Предотвращает зависания searchd при ротации таблиц с огромным объемом данных для предварительного кэширования
  ...
  * [unlink_old](Server_settings/Searchd.md#unlink_old) - Следует ли удалять копии таблиц с расширением .old при успешной ротации
...
* [--logreplication](Starting_the_server/Manually.md#searchd-command-line-options) - Включает дополнительный отладочный вывод репликации в журнал сервера
