...
* [Массовый импорт](Data_creation_and_modification/Adding_documents_to_a_table/Adding_documents_to_a_real-time_table.md#Bulk-import) - Загружает большой пакет данных в существующую локальную таблицу реального времени
...
* [PURGE BULK_IMPORT](Node_info_and_management/PURGE.md#PURGE-BULK_IMPORT) - Удаляет промежуточные файлы, оставшиеся после массового импорта
