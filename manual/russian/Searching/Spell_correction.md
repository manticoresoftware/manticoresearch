...
| force_bigrams | Принудительное использование биграмм (2-символьных n-грамм) вместо триграмм для всех длин слов, что может улучшить сопоставление слов с ошибками транспозиции | 0 (использовать триграммы для слов ≥6 символов) |
