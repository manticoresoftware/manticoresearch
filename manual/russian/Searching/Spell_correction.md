...
* <a href="https://github.manticoresearch.com/manticoresoftware/manticoresearch?query=fature&filters%5Bcomment%5D%5B%5D=28798446&filters%5Bcommon%5D%5Brepo_id%5D%5B%5D=95614931&sort=&search=keyword-search-fuzzy-layouts">Это демо</a> демонстрирует функциональность нечёткого поиска:
  ![Пример нечёткого поиска](fuzzysearch.png){.scale-0.7}
