...
`progressive_merge` — это директива конфигурации, которая при включении объединяет дисковые чанки таблицы реального времени от меньших к большим. Такой подход ускоряет процесс слияния и снижает коэффициент усиления чтения/записи. Эта настройка всегда включена и оставлена в конфигурации только для обратной совместимости.
