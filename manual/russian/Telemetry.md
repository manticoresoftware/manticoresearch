...
| `arg_*` | Аргументы, использованные для запуска инструмента (без имен таблиц и т. п.) |
...
| `restore_target_exists` | Возникает, когда папка или таблица уже существует в папке назначения для восстановления |
