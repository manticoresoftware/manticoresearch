...
set ( FLOAT_TOLERANCE "$ENV{FLOAT_TOLERANCE}" )
...
set ( MCL_RUNTIME_ARTIFACT_DIR "$ENV{MCL_RUNTIME_ARTIFACT_DIR}" )
set ( BUILD_EMBEDDINGS_LOCALLY "$ENV{BUILD_EMBEDDINGS_LOCALLY}" )
set ( MANTICORE_KNN_EMBEDDINGS_LIB "$ENV{MANTICORE_KNN_EMBEDDINGS_LIB}" )
...
if (FLOAT_TOLERANCE)
	LIST ( APPEND CONFIG_OPTIONS "FLOAT_TOLERANCE=${FLOAT_TOLERANCE}" )
endif ()
...
if ( MCL_RUNTIME_ARTIFACT_DIR )
	LIST ( APPEND CONFIG_OPTIONS "MCL_RUNTIME_ARTIFACT_DIR=${MCL_RUNTIME_ARTIFACT_DIR}" )
endif ()

if ( DEFINED ENV{BUILD_EMBEDDINGS_LOCALLY} AND NOT "$ENV{BUILD_EMBEDDINGS_LOCALLY}" STREQUAL "" )
	LIST ( APPEND CONFIG_OPTIONS "BUILD_EMBEDDINGS_LOCALLY=${BUILD_EMBEDDINGS_LOCALLY}" )
endif ()

if ( MANTICORE_KNN_EMBEDDINGS_LIB )
	LIST ( APPEND CONFIG_OPTIONS "MANTICORE_KNN_EMBEDDINGS_LIB=${MANTICORE_KNN_EMBEDDINGS_LIB}" )
endif ()
...
ctest_update ()
ctest_configure ( RETURN_VALUE configure_ret )
if ( configure_ret )
	file ( GLOB configure_logs "${CTEST_BINARY_DIRECTORY}/Testing/Temporary/LastConfigure*.log" )
	foreach ( configure_log ${configure_logs} )
		message ( STATUS "Configure log: ${configure_log}" )
		file ( READ "${configure_log}" configure_output )
