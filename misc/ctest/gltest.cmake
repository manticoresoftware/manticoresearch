...
if ( CTEST_REGEX )
	ctest_test ( INCLUDE "${CTEST_REGEX}" EXCLUDE "${CTEST_EXCLUDE_REGEX}" ${ctest_test_args} )
else()
  	if ( CTEST_START AND CTEST_END )
  		ctest_test ( START ${CTEST_START} END ${CTEST_END} EXCLUDE "${CTEST_EXCLUDE_REGEX}" ${ctest_test_args})
	else()
		ctest_test ( EXCLUDE "${CTEST_EXCLUDE_REGEX}" ${ctest_test_args})
	endif()
endif()
