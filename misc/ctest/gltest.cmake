...
# common test options
set ( CONFIG_OPTIONS "WITH_ODBC=1;WITH_RE2=1;WITH_STEMMER=1;WITH_POSTGRESQL=${WITH_POSTGRESQL};WITH_EXPAT=1;WITH_SSL=1;WITH_ZLIB=1" )
...
if ( CTEST_REGEX )
	ctest_test ( RETURN_VALUE retcode INCLUDE "${CTEST_REGEX}" EXCLUDE "${CTEST_EXCLUDE_REGEX}" REPEAT UNTIL_PASS:${RETRIES})
else()
  if ( CTEST_START AND CTEST_END )
  	ctest_test ( START ${CTEST_START} END ${CTEST_END} EXCLUDE "${CTEST_EXCLUDE_REGEX}" RETURN_VALUE retcode REPEAT UNTIL_PASS:${RETRIES})
	else()
		ctest_test ( EXCLUDE "${CTEST_EXCLUDE_REGEX}" RETURN_VALUE retcode REPEAT UNTIL_PASS:${RETRIES})
	endif()
endif()
