...
set ( MCL_LOCAL_RUNTIME "$ENV{MCL_LOCAL_RUNTIME}" )
...
if ( DEFINED ENV{MCL_LOCAL_RUNTIME} AND NOT "$ENV{MCL_LOCAL_RUNTIME}" STREQUAL "" )
	LIST ( APPEND CONFIG_OPTIONS "MCL_LOCAL_RUNTIME=${MCL_LOCAL_RUNTIME}" )
endif ()
