...
static const char * GET_MYSQL_LIB()
{
	...
	static decltype (&mysql_options) sph_mysql_options = nullptr;
	...
	static bool InitDynamicMysql()
	{
		const char * sFuncs[] = { "mysql_free_result", "mysql_next_result", "mysql_use_result"
			...
			, "mysql_init", "mysql_options", "mysql_real_connect", "mysql_close"
		...
		void ** pFuncs[] = { (void **) &sph_mysql_free_result, (void **) &sph_mysql_next_result
			...
			, (void **) &sph_mysql_options, (void **) &sph_mysql_real_connect, (void **) &sph_mysql_close
	...
	#define sph_mysql_options mysql_options
...
bool CSphSource_MySQL::SqlConnect ()
{
	...
	{
		sph_mysql_options ( &m_tMysqlDriver, MYSQL_OPT_SSL_KEY, m_sSslKey.cstr() );
		sph_mysql_options ( &m_tMysqlDriver, MYSQL_OPT_SSL_CERT, m_sSslCert.cstr() );
		sph_mysql_options ( &m_tMysqlDriver, MYSQL_OPT_SSL_CA, m_sSslCA.cstr() );
	}
