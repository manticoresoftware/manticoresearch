...
SPH_QUERY_STATE ( FINALIZE1,	"finalize1" ) \
SPH_QUERY_STATE ( FINALIZE2,	"finalize2" ) \
SPH_QUERY_STATE ( FINALIZE3,	"finalize3" ) \
SPH_QUERY_STATE ( FINALIZE4,	"finalize4" ) \
SPH_QUERY_STATE ( FINALIZE5,	"finalize5" ) \
SPH_QUERY_STATE ( FINALIZE6,	"finalize6" ) \
SPH_QUERY_STATE ( FINALIZE7,	"finalize7" ) \
