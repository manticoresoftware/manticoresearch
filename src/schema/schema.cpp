...
bool CSphSchema::IsReserved ( const char* szToken )
{
	static const char * dReserved[] =
	{
		...
		"MOD", "NOT", "NO_COLUMNARSCAN", "NO_DOCIDINDEX", "NO_OPTIMIZEFULLTEXTFILTERS",
		"NO_SECONDARYINDEX", "NULL", "OFFSET", "OPTIMIZEFULLTEXTFILTERS", "OR", "ORDER",
		"REGEX", "RELOAD", "SECONDARYINDEX", "SELECT", "SYSFILTERS", "TRUE", "USE", NULL
	};
