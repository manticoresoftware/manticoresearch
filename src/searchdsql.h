...
constexpr const char* SqlStmt2Str(SqlStmt_e eStmt)
{
	...
	"show_settings", "alter_rebuild_si", "kill", "show_locks", "show_scroll", "show_table_indexes", "alter_rebuild_knn", "alter_rebuild_embeddings",
	};
	return dNames[eStmt];
}
...
public:
	...
	bool					m_bAlterKnnFromSpecified = false;
