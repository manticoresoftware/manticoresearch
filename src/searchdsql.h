...
//	STMT_SELECT_DUAL, // deprecated to STMT_SELECT_COLUMNS as more general
	...
	STMT_ALTER_EMBEDDINGS_MAX_INPUT_TOKENS,
	STMT_JOIN_CLUSTER,
	STMT_CLUSTER_CREATE,
	STMT_CLUSTER_DELETE,
	STMT_CLUSTER_EXIT,
...
constexpr const char* SqlStmt2Str(SqlStmt_e eStmt)
{
	...
	"alter_index_settings", "alter_embeddings_api_key", "alter_embeddings_api_url", "alter_embeddings_api_timeout", "alter_embeddings_max_input_tokens", "join_cluster", "cluster_create", "cluster_delete", "cluster_exit", "cluster_index_add",
	...
	"reload_auth", "show_usage", "show_permissions", "show_users", "show_token", "set_password", "token", "create_user", "drop_user", "grant", "revoke", "backup", "purge"
			};
	return dNames[eStmt];
}
