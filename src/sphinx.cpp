...
static unsigned char stem_en_vowels[] = "aeiouy";
static unsigned char stem_en_vwxy[] = "aeiouywxY";
static unsigned char stem_en_doubles[] = "bdfgmnprt";
static unsigned char stem_en_li[] = "bcdeghkmnrt";

int stem_en_iv(unsigned char l)
{
	register unsigned char *v = stem_en_vowels;
	while (*v && *v != l) v++;
	return (*v == l) ? 1 : 0;
}

int stem_en_id(unsigned char l)
{
...
int stem_en_il(unsigned char l)
{
	register unsigned char *v = stem_en_li;
	while (*v && *v != l) v++;
	return (*v == l) ? 1 : 0;
}

int stem_en_ivwxy(unsigned char l)
{
	register unsigned char *v = stem_en_vwxy;
	while (*v && *v != l) v++;
	return (*v == l) ? 1 : 0;
}

int stem_en_suffix(unsigned char *word, int *len, int r,
...
void stem_en(unsigned char *word)
{
	int i, j, len, r1, r2;
